# Generated by Django 2.2.16 on 2022-08-25 15:29
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('slug', models.CharField(max_length=50, unique=True, validators=[django.core.validators.RegexValidator(message='Недопустимые символы', regex='^[-a-zA-Z0-9_]+$')])),
            ],
        ),
        migrations.CreateModel(
            name='Genre',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('year', models.IntegerField(blank=True, null=True, validators=[reviews.validators.year_validator])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pub_date', models.DateTimeField(auto_now_add=True, db_index=True, help_text='Дата рецензии', verbose_name='Дата рецензии')),
